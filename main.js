        ...
        if (tarea.email == correo) {
          ...
          html += `
                    <li class="list-group-item list-group-item-action mt-2">
                      ...
                      <div>
                        <button class="btn  btn-outline-danger btn-eliminar" data-id="${doc.id}">
                        <i class="bi bi-trash"></i>
                        Eliminar
                        </button>
                        <button class="btn btn-outline-success btn-editar" data-id="${doc.id}">
        ...
        if (tarea.email != correo) {
          ...
          html2 += `
                    <li class="list-group-item list-group-item-action mt-2">
                      ...
                      <p>${tarea.descripcion}</p>
                      <div>
                        <button class="btn btn-outline-info btn-eliminar" data-id="">
                        <i class="bi bi-heart"></i>
                          Like
                        </button>
                        <button class="btn btn-outline-dark btn-editar" data-id="">
