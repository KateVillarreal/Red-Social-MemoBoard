...
auth.onAuthStateChanged(async function (user) {
  if (user) {
        ...
        if (tarea.email == correo) {
          ...
          html += `
                    <li class="list-group-item list-group-item-action mt-2">
                      ...
                      <div>
                        <button class="btn btn-outline-success btn-editar bi bi-pencil" data-id="${doc.id}">
                        
                        Editar
                        </button>
                        <button class="btn btn-outline-danger btn-eliminar bi bi-trash3" data-id="${doc.id}">
                        
                        Eliminar
                        </button>
                        <button class="btn btn-outline-info btn-like" data-id="${doc.id}">
                          <i class="bi bi-heart-fill"></i>
                          ${textoLike}
                          </button>
                        <button class="btn btn-outline-warning btn-verComentarios" data-id="${doc.id}" data-bs-toggle="modal" data-bs-target="#modalComentarios">
          ...
          html2 += `
                      ...
                      <div class="border mt-2"></div>
                        ...
                        <div>
                          ...
                          <button class="btn btn-outline-dark btn-verComentarios" data-id="${doc.id}" data-bs-toggle="modal" data-bs-target="#modalComentarios">
    ...
    const contenedorTareasTodas = $("#contenedor-tareas-todas");
    contenedorTareas.html('<h3 class="text-black">Inicia sesión para ver tus publicaciones</h3>');
